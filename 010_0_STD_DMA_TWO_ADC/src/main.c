...
void ADC_Config()
{
   ...
   ADC_CommonInitStruct.ADC_DMAAccessMode = ADC_DMAAccessMode_1; //We will use only 1 channel

   ADC_CommonInit(&ADC_CommonInitStruct);

   ADC_InitStruct.ADC_Resolution = ADC_Resolution_12b; //
   ADC_InitStruct.ADC_ScanConvMode = ENABLE; // We will use only one channel
